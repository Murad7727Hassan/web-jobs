...
<!-- end header   -->
    ...
    <!-- start content  -->
    <section class="content about services py-5">
 ...
 <section class="my-5">
    <div class="container">
         <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-3 d-flex justify-content-center ">
                <img src="images/job5.webp" class="img-fluid" alt="" srcset="">
            </div>
            <div class="col-md-3 d-flex justify-content-center ">
                <img src="images/job7.jpg" class="img-fluid" alt="" srcset="">
            </div>
            <div class="col-md-3 d-flex justify-content-center ">
