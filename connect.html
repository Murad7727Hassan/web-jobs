            ...
            <div class="above my-5">
              <div class="container p-5">
                  <div class="row">
                   ...
                   <div class="col-md-4">
                     <img src="images/person1.jpg" class="img-fluid" alt="" srcset="">
                   </div>
                  </div>
              </div>
           </div>
                ...
                <div class="row">
                    <div class="col mb-5 px-5">
                        <div class="card  w-100">
                            <h5 class="card-title text-center mt-4 fw-bold">IT Suport</h5>
                            <img src="images/person1.jpg" class="card-img-top my-3 mb-1" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col mb-5 px-5">
                        <div class="card  w-100">
                            <h5 class="card-title text-center mt-4 fw-bold">Sales</h5>
                            <img src="images/person2.jpg" class="card-img-top my-3 mb-1" alt="...">
                            <div class="card-body">
                              <p class="card-text text-center">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                               <a href="#" class="btn my-3 mt-1 text-primary text-center w-100">Go somewhere</a>
                               <a href="#" class="btn btn-outline-primary mb-3 w-100">Connact us</a>
                    ...
                    <div class="col mb-5 px-5">
                        <div class="card  w-100">
                            <h5 class="card-title text-center mt-4 fw-bold">Marketing</h5>
