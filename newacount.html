...
<body>
    ...
    <!-- start content  -->
    <section class="content mb-5" style="margin: 115px auto;">
      <div class="above mt-5 login">
        <div class="container p-5 mt-5 shadow-lg ">
          <div class="row">      
            <h1 class="text-center">New Acount</h1>
        </div>
            <div class="row ">
              <div class="col">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">configin Password </label>
                  <input type="password" class="form-control" id="exampleFormControlInput1" placeholder="password">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <a href="profile.html" class="btn btn-outline-primary mb-3 w-100">create</a>
                </div>
                <div class="mb-3">
                    <a href="login.html" class="btn text-primary mb-3 w-100">Sing in</a>
                </div>
              </div>
        </div>
     </div>
